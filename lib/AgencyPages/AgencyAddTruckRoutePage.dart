...
class AgencyAddTruckRoutePage extends StatefulWidget {
  final String userId;
  AgencyAddTruckRoutePage({this.userId});

  @override
  _AgencyAddTruckRoutePageState createState() =>
      _AgencyAddTruckRoutePageState(userId: userId);
}

class _AgencyAddTruckRoutePageState extends State<AgencyAddTruckRoutePage> {
  String userId;
  _AgencyAddTruckRoutePageState({this.userId});
  ...
  _submitTruckRoute() {
    DocumentReference ds =
        FirebaseFirestore.instance.collection('TruckRoutes').doc();
    Map<String, dynamic> tasks = {
      ...
      'route_date_posted': DateTime.now().millisecondsSinceEpoch,
      'route_entry_id': ds.id,
      'route_requests': 0,
      'route_price': '',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Your route from ${startingPoint.formattedAddress} to ${endingPoint.formattedAddress} has successfully been submitted!',
                        style: GoogleFonts.quicksand(
                          textStyle: TextStyle(
                            fontSize: 16.0,
                            color: Colors.black,
