...
class AdminSetupAccountPage extends StatefulWidget {
  final String userId;
  final String userPhone;
  AdminSetupAccountPage({this.userId, this.userPhone});

  @override
  _AdminSetupAccountPageState createState() =>
      _AdminSetupAccountPageState(userId: userId, userPhone: userPhone);
}

class _AdminSetupAccountPageState extends State<AdminSetupAccountPage> {
  String userId;
  String userPhone;
  _AdminSetupAccountPageState({this.userId, this.userPhone});
  ...
  sendNotification() {
    ...
    DocumentReference ds = FirebaseFirestore.instance
        ...
        .doc();
    Map<String, dynamic> tasks = {
      'notification_tittle': 'Karibu ${nameList[0]}!',
  ...
  Future<void> _startUpload() async {
    ...
    try {
      await storage.ref('Profiles/$userId.jpg').putFile(_imageFile);
      print('File Uploaded');
